...
public class GoogleAdMobController : MonoBehaviour
{
    ...
    public static GoogleAdMobController instance; //RAR
    ...
    [SerializeField] private AdPosition AdPositionBanner; //RAR
...
*/
    ...
    {
        if (rewardedAd != null  && rewardedAd.CanShowAd()) //RAR
        {
